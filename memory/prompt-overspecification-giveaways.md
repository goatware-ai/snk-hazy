...
- 2026-09-15 (a rejection, coded P8): a prompt due date and the golden's Date line sit at least 21 days after the build (first commit of prompt.md), or the prompt gives no due date; a September 8 deadline on a September 1 build read as an impossible timeline at review.
