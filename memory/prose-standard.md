...
**Comma rules, in the reviewer's words** (a rejection, 2026-09-05): a comma before the
...
**The send-back classes from one task's two rounds (2026-08-21 and 08-24):** comma splices ("Let me
...
(a round 4). **The rubric is prose too**: desk register in criteria (trimmed,
...
and/so. Write "partially", never "partly" (operator, 2026-09-03; neither is a tell, the desk
picks one form).

**Verbless fragments fail the platform's Prompt spelling and grammar check (pre-submission, 2026-09-11):** "One workbook back, named X.xlsx" and "The program order sized item by item" were called malformed; write the deliverable ask as a full sentence ("Build one workbook, named X.xlsx. It carries ...").
- 2026-09-11 (a round 4, A21): the platform's authorship reader fails a docx whose sections
